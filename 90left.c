...
#define TURN_TARGET_TICKS 164
#define TURN_TARGET_TICKS90 164
#define DRIVE_TARGET_TICKS 50
...

{
    ...
    while (1)
    {
        ...
        case SETUP_BACKWARDS2:
                         ...
                         // Start the motors here so we only have to start them once
                         set_left_motor_pwm(.33);
                         set_right_motor_pwm(.35);
